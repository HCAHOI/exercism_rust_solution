...
#[test]
#[ignore]
fn invalid_if_area_code_starts_with_1_on_valid_11digit_number() {
    process_clean_case("1 (123) 456-7890", None);
}

#[test]
#[ignore]
fn invalid_if_area_code_starts_with_0_on_valid_11digit_number() {
...
#[test]
#[ignore]
fn invalid_if_exchange_code_starts_with_1_on_valid_11digit_number() {
    process_clean_case("1 (223) 156-7890", None);
}

#[test]
#[ignore]
fn invalid_if_exchange_code_starts_with_0_on_valid_11digit_number() {
